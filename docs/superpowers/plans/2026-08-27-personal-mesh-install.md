...
- [ ] Implement strict Codable wire types that reject unknown top-level schema versions and normalize peers into bounded value types. Treat a duplicate endpoint assigned to different node IDs as invalid status.
