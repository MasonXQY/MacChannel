...
release_notes="$repo_root/Distribution/ReleaseNotes/v1.2.6.md"
...
prepare_fixture
MACCHANNEL_TEST_BUILD_NUMBER=18 expect_failure manifest run_feed_builder
...
grep -F "明确选择“发送剪贴板”" <<<"$description_value" >/dev/null
