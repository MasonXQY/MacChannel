...
release_notes="$repo_root/Distribution/ReleaseNotes/v1.2.3.md"
...
prepare_fixture
MACCHANNEL_TEST_VERSION=1.2.2 expect_failure manifest run_feed_builder
prepare_fixture
MACCHANNEL_TEST_BUILD_NUMBER=15 expect_failure manifest run_feed_builder
...
grep -F "安全服务可能停止自动连接" <<<"$description_value" >/dev/null
